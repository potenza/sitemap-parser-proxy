...
_Ruby Gem to parse sitemaps.org compliant sitemaps_
...
```ruby
sitemap = SitemapParserProxy.new "http://ben.balter.com/sitemap.xml"
```
...
```ruby
sitemap = SitemapParserProxy.new('http://ben.balter.com/sitemap.xml', {recurse: true})
```
...
```ruby
sitemap = SitemapParserProxy.new('http://ben.balter.com/sitemap.xml', {recurse: true, url_regex: /sitemapregex/})
```

### Typhoeus Options

```ruby
sitemap = SitemapParserProxy.new('http://ben.balter.com/sitemap.xml', { userpwd: "username:password" })
```
